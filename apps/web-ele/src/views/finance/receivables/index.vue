...
import { getReceivablesList } from '#/api';
...
const [Grid, gridApi] = useVbenVxeGrid({
    ...
    proxyConfig: {
      ...
      ajax: {
        query: async ({ page, sort }, formValues) => {
          return await getReceivablesList({
            ...formValues,
  ...
  } as VxeTableGridOptions<ReceivablesApi.Receivables>,
  gridEvents: {
    // cellClick: ({ row }) => {
  ...
  } as VxeGridListeners<ReceivablesApi.Receivables>,
});
